<x-app-layout>
        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white :bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4">
                <div class="p-3 relative border overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    @else
                        <table id="cigarette-table" class="w-full text-sm text-center rtl:text-right text-gray-500 dark:text-dark-400">
    ...
    <script>
        ...
        table.buttons().container().appendTo('#cigaretteTable_wrapper.col-md-6:eq(0)');
    </script>
</x-app-layout>
