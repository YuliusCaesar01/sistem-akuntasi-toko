    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Stock Barang Dropdown -->
                <div class="relative hidden sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div x-show="stockDropdownOpen" @click.outside="stockDropdownOpen = false" class="absolute mt-2 w-48 rounded-md shadow-lg origin-top-left left-0">
                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                            ...
                            <x-dropdown-link href="{{ route('stock-barang.gas') }}">
                                {{ __('Gas') }}
                            </x-dropdown-link>
                            <x-dropdown-link href="{{ route('stock-barang.rokok') }}">
                                {{ __('Rokok') }}
                            </x-dropdown-link>
                        </div>
                    </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div @click.away="open = false" class="relative">
                <x-responsive-nav-link @click="stockDropdownOpen = ! stockDropdownOpen" :active="request()->routeIs('stock-barang')">
                    {{ __('Stock Barang') }}
                    <svg class="ms-1 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 9l6 6 6-6" />
                    </svg>
                ...
                <div x-show="stockDropdownOpen" class="mt-2 space-y-1">
                    ...
                    <x-responsive-nav-link href="{{ route('stock-barang.gas') }}">
                        {{ __('Gas') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link href="{{ route('stock-barang.rokok') }}">
                        {{ __('Rokok') }}
                    </x-responsive-nav-link>
                </div>
            </div>
